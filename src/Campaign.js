...
const campaignarr = [
    ...
    { "id": 10, "name": "Realbridge", "startDate": "3/5/2018", "endDate": "10/2/2017", "Budget": 505602, "userId": 15 }
];
...
function CampaignList() {
    ...
    const [filteredCampaigns, setFilteredCampaigns] = useState(campaignarr);
    ...
    const search = () => {
            ...
            const filteredCampaigns = campaignarr.filter((item) => {
